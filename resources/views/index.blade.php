...
<html lang="en">
  ...
  <body>
    <!-- navbar -->
    <nav class="navbar navbar-expend-lg navbar-light shadow-sm" 
    style="background-color: rgb(216, 245, 241);">
        <div class="container">
            <a href="#" class="navbar-brand">Monti Mart</a>
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a href="Modul3.html" class="nav-link active" aria-current="page">Home</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link">Dahboard</a>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link">Lacak Paket</a>
                    </li>
                </ul>
                <spn class="navbar-nav ml-auto">
                        ...
                        <div class="card-body p-4">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="col-md-2 col-lg-2 col-xl-2">
                                    <img src="macbook.jpeg" alt="Macbook" class="img-fluid rounded-3">
                                </div>
                                <div class="col-md-3 col-lg-3 col-xl-3">
                                    <p class="lead fw-normal mb-2">Macbook</p>
                                ...
                                <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                    <h5 class="mb-0">Rp. 25.000.000</h5>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <footer class="bg-dark" id="footer">
        <div class="container">
          <div class="row">
            <div class="col-md-4 pt-5">
              <h2 class="h2 text-success border-bottom pb-3 border-light logo">Monti mart</h2>
              <ul class="list-unstyled text-light footer-link-list">
                <li>
                  <i class="fas fa-map-marker-alt fa-fw"></i>Komp.lp lama no.5
                </li>
                <li>
                  <i class="fa fa-phone fa-fw"></i>
                  <a href="tel:010-020-0340" class="text-decoration-none">0896-1765-4480</a>
                </li>
                <li>
                  <i class="fa fa-phone fa-fw"></i>
                  <a href="mailto:info@company.com" class="text-decoration-none">info@monticompany.com</a>
                </li>
              </ul>
            </div>
            <div class="col-md-4 pt-5">
        ...
        <div class="w-100 bg-black py-3">
          <div class="container">
            <div class="row pt-2">
              <div class="col-12">
                <p class="text-left text-light">Copyright &copy; 2023 Dream</p>
              </div>
            </div>
          </div>
        </div>
